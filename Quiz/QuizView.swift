...
struct QuizView: View {
    ...
    let quizItems: [QuizItem] = [
        ...
        QuizItem(
            question: "Appleの共同創業者は誰？（一人選んでください）",
            options: ["ビル・ゲイツ", "スティーブ・ウォズニアック", "マーク・ザッカーバーグ"],
            correctAnswerIndex: 1
        ),
        
        QuizItem(
            question: "最初のMacintoshが発表された年は？",
            options: ["1976年", "1984年", "1998年"],
            correctAnswerIndex: 1
        ),
        
        QuizItem(
            question: "Appleの本社があるカリフォルニア州の都市は？",
            options: ["サンフランシスコ", "パロアルト", "クパチーノ"],
            correctAnswerIndex: 2
        ),
        
        QuizItem(
            question: "SwiftUIが最初に発表されたWWDCの年は？",
    ...
    var body: some View {
        ZStack {
            VStack {
                ...
                // Answer Options
                VStack(spacing: 16){
                    ForEach(0..<currentQuestion.options.count, id: \.self) {index in Button{
                        answerTapped(index)
                    }label: {
